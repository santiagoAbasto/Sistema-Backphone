    ...
    if (!open) {
        return (
            <button type="button" onClick={toggle}
                className="inline-flex items-center gap-1.5 rounded-lg border border-[rgb(var(--acento-rgb)_/_0.2)] bg-[rgb(var(--acento-rgb)_/_0.06)] px-3 py-1.5 text-xs font-semibold text-[#3B2820] hover:bg-[rgb(var(--acento-rgb)_/_0.1)]">
    ...
    return (
        <section aria-label="Guía de la sección" className="rounded-2xl border border-[rgb(var(--acento-rgb)_/_0.2)] bg-[rgb(var(--acento-rgb)_/_0.06)] px-4 py-3">
            <div className="flex items-center justify-between gap-4">
                ...
                <button type="button" onClick={toggle} className="shrink-0 rounded-lg px-2 py-1 text-xs font-semibold text-[#3B2820] hover:bg-white">
                    Ocultar guía
                </button>
            </div>
